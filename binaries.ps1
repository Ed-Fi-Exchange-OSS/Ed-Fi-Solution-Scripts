@(  
    @{  name = "Api"; type = "WebApp";
        ...
        databases = @(  #all InstallTypes
            @{src = "EdFi_Admin"; dest = "$($NamePrefix)_EdFi_Admin_$NameSuffix" }
            @{src = "EdFi_Security"; dest = "$($NamePrefix)_EdFi_Security_$NameSuffix" }
            # InstallType Specific
            @{src = "EdFi_Ods_Minimal_Template"; dest = "$($NamePrefix)_EdFi_Ods_$NameSuffix"; InstallType = "Staging" }
            @{src = "EdFi_Ods_Populated_Template"; dest = "$($NamePrefix)_EdFi_Ods_$NameSuffix"; InstallType = "Demo" }
        )
        envConnectionStrings = @{
            Staging = @{
                "EdFi_Ods"               = "Server=.; Database=$($NamePrefix)_EdFi_ODS_$NameSuffix; Trusted_Connection=True; Application Name=EdFi.Ods.WebApi;"
                "EdFi_Admin"             = "Server=.; Database=$($NamePrefix)_EdFi_Admin_$NameSuffix; Trusted_Connection=True; Application Name=EdFi.Ods.WebApi;"
                "EdFi_Security"          = "Server=.; Database=$($NamePrefix)_EdFi_Security_$NameSuffix; Trusted_Connection=True; Persist Security Info=True; Application Name=EdFi.Ods.WebApi;"
                "EdFi_master"            = "Server=.; Database=master; Trusted_Connection=True; Application Name=EdFi.Ods.WebApi;"
                "BulkOperationDbContext" = "Server=.; Database=$($NamePrefix)_EdFi_Bulk_$NameSuffix; Trusted_Connection=True; MultipleActiveResultSets=True; Application Name=EdFi.Ods.WebApi;"
            }
            Demo    = @{
                "EdFi_Ods"               = "Server=.; Database=$($NamePrefix)_EdFi_ODS_$NameSuffix; Trusted_Connection=True; Application Name=EdFi.Ods.WebApi;"
                "EdFi_Admin"             = "Server=.; Database=$($NamePrefix)_EdFi_Admin_$NameSuffix; Trusted_Connection=True; Application Name=EdFi.Ods.WebApi;"
    ...
    @{ name                    = "AdminApp";
        ...
        connectionStrings      = @{
            "EdFi_Ods_Production" = "Server=.; Database=$($NamePrefix)_EdFi_Ods_$NameSuffix; Trusted_Connection=True; Application Name=EdFi.AdminApp;"
            "EdFi_Admin"          = "Server=.; Database=$($NamePrefix)_EdFi_Admin_$NameSuffix; Trusted_Connection=True; Application Name=EdFi.AdminApp;"
            "EdFi_Security"       = "Server=.; Database=$($NamePrefix)_EdFi_Security_$NameSuffix; Trusted_Connection=True; Application Name=EdFi.AdminApp;"
        };
