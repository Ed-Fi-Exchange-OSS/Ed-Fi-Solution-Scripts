...
## Solutions Included
Please refer to the [Starter Kits on Ed-Fi Techdocs](https://techdocs.ed-fi.org/display/SK/Starter+Kits) to get started.

## Installing
Each Starter Kit guide has detail on how to complete installation for each solution. Please refer to the [Starter Kits on Ed-Fi Techdocs](https://techdocs.ed-fi.org/display/SK/Starter+Kits) as your primary guide.
The information presented here is for reference by advanced users or for working with a base installation of the Ed-Fi Suite with no starter kit.
